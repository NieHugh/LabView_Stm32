...
<Project Type="Project" LVVersion="11008008">
   ...
   <Value>/PD7</Value>
		...
		<Item Name="GPIO-Port E" Type="Folder">
			<Item Name="KEY_1" Type="Elemental IO">
				<Property Name="eioAttrBag" Type="Xml"><AttributeSet name="">
   <Attribute name="resource">
   <Value>/PE2</Value>
   </Attribute>
			...
			<Item Name="KEY_2" Type="Elemental IO">
				<Property Name="eioAttrBag" Type="Xml"><AttributeSet name="">
   <Attribute name="resource">
   <Value>/PE3</Value>
   </Attribute>
			...
			<Item Name="KEY_3" Type="Elemental IO">
				<Property Name="eioAttrBag" Type="Xml"><AttributeSet name="">
   <Attribute name="resource">
   <Value>/PE4</Value>
   </Attribute>
   ...
   <Value>/PE5</Value>
		...
		<Item Name="外部IO中断实验.vi" Type="VI" URL="../外部IO中断实验.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Mask Unmask Interrupt Line_F4.vi" Type="VI" URL="/&lt;vilib&gt;/STM32_DriverVI_Interface_F4/Interrupt/Mask Unmask Interrupt Line_F4.vi"/>
				...
				<Item Name="屏蔽或开启中断线_F4.ctl" Type="VI" URL="/&lt;vilib&gt;/STM32_DriverVI_Interface_F4/Interrupt/屏蔽或开启中断线_F4.ctl"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Application" Type="EmbeddedBuildSpec">
				<Property Name="BDTFlags" Type="Str">7A4C5B1C-FF4D-44C5-9DCD-FE0F6E16928C</Property>
				...
				<Property Name="SourceTopLevelVI" Type="Ref">/My_ARM_Starter_Board_F4/外部IO中断实验.vi</Property>
